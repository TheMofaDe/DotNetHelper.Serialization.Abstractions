...
namespace DotNetHelper.Serialization.Binary.Tests
{
    ...
    public class BinaryDeserializerTextFixture
    {


        public DataSourceBinary DataSource { get; set; } = new DataSourceBinary();

        public BinaryDeserializerTextFixture()
        {
        ...
        [Test]
        public void Test_Deserialize_Binary_To_Dynamic()
        {
            var dyn = DataSource.Deserialize(MockData.EmployeeAsBinaryString);
        ...
        [Author("Joseph McNeal Jr", "josephmcnealjr@gmail.com")]
        [Test]
        public void Test_Deserialize_Binary_To_Generic()
        {
            var employee = DataSource.Deserialize<Employee>(MockData.EmployeeAsBinaryString);
        ...
        [Author("Joseph McNeal Jr", "josephmcnealjr@gmail.com")]
        [Test]
        public void Test_Deserialize_Binary_To_Typed_Object()
        {
            var employee = DataSource.Deserialize(MockData.EmployeeAsBinaryString, typeof(Employee));
        ...
        [Author("Joseph McNeal Jr", "josephmcnealjr@gmail.com")]
        [Test]
        public void Test_Deserialize_Binary_To_Typed_Object_Of_List()
        {
            var employees = DataSource.Deserialize(MockData.EmployeeAsBinaryStringList, typeof(List<Employee>));
        ...
        [Author("Joseph McNeal Jr", "josephmcnealjr@gmail.com")]
        [Test]
        public void Test_Deserialize_Binary_To_Strongly_Typed_Object_Of_List()
        {
            var employees = DataSource.DeserializeToList(MockData.EmployeeAsBinaryStringList, typeof(List<Employee>));
        ...
        [Author("Joseph McNeal Jr", "josephmcnealjr@gmail.com")]
        [Test]
        public void Test_Deserialize_Binary_To_Dynamic_List()
        {
            var employees = DataSource.DeserializeToList(MockData.EmployeeAsBinaryStringList);
        ...
        [Author("Joseph McNeal Jr", "josephmcnealjr@gmail.com")]
        [Test]
        public void Test_Deserialize_Binary_To_Generic_List()
        {
            var employees = DataSource.DeserializeToList<Employee>(MockData.EmployeeAsBinaryStringList);
